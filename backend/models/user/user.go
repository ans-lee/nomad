...
type User struct {
    Email string `json:"email" binding:"required" validate:"min=5,max=128,regexp=\\b[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\\.[A-Z|a-z]{2\\,}\\b"`
...
type LogIn struct {
    Email string `json:"email" binding:"required" validate:"min=1,max=128,regexp=\\b[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\\.[A-Z|a-z]{2\\,}\\b"`
